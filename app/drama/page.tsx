  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rice-paper via-ivory-white to-cinnabar-red/10 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-cinnabar-red/20 to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-ancient-gold/20 to-transparent" />

        {/* 戏台帷幕 */}
        <div className="absolute top-0 left-0 w-16 h-full bg-gradient-to-r from-cinnabar-red/30 to-transparent" />
        <div className="absolute top-0 right-0 w-16 h-full bg-gradient-to-l from-cinnabar-red/30 to-transparent" />
      </div>
      ...
      <div className="absolute inset-0">
        {Array.from({ length: 6 }).map((_, i) => (
          <motion.div
            key={i}
            className="absolute text-cinnabar-red/30 text-xl"
            style={{
      ...
      <div className="relative z-10 px-6">
        ...
        <Card className="ancient-card p-6 mb-8 bg-gradient-to-br from-rice-paper to-ivory-white">
          <h4 className="text-lg font-bold ancient-title text-ink-black mb-3 text-center">🎭 宋代戏曲文化</h4>
          <div className="space-y-2 ancient-text text-deep-ink text-sm">
            <p>• 宋代是中国戏曲艺术的重要发展期</p>
            <p>• 脸谱艺术体现了中国传统美学</p>
            <p>• 不同脸谱代表不同的性格特征</p>
            <p>• 戏曲融合了诗词、音乐、舞蹈等艺术</p>
            <p>• 梨园文化承载着深厚的历史底蕴</p>
          </div>
        </Card>
      </div>
